...
def initialize(player1_module, player2_module, time_per_move=1.0,
        turn_limit=60):
    global FINISHED
    global player1
    global player2
    ...
    global TURN_LIMIT
    FINISHED = False
    player1 = player1_module
    player2 = player2_module
    CURRENT_PLAYER = BC.WHITE
...
def runGame():
    """
    This function returns a continuation representing a game state.
    """
    # Set up for the match, and report on its details: 
    # TODO: turn this function into an iterator.
    ...
    while not FINISHED:
        ...
        print(currentState)
        turnCount += 1
        yield (moveReport, utteranceReport, currentState)
